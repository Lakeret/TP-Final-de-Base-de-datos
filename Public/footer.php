...
<!-- Footer -->
<footer style="background: linear-gradient(135deg, var(--forest-green), var(--light-green)); color: white; padding: 3rem 0; margin-top: 4rem;">
    <div class="container">
        <div class="row">
        ...
        <div class="text-center" style="opacity: 0.8;">
            <p class="mb-0">© <?php echo date('Y'); ?> Cabañas del Bosque - Todos los derechos reservados 🌲</p>
        </div>
    </div>
</footer>
